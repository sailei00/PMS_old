...
function selectItem(t) {
	var pcode = parent.document.getElementById("item.code");
	var pname = parent.document.getElementById("item.name");
	var pmodel = parent.document.getElementById("item.model");
	var punit = parent.document.getElementById("item.unit");
...
<body onload="reSetIframeHeight()">
	...
	<input type="hidden" value="双击框查询页面" name="abc">
		<center>
			<table border="1">
				<tr>
